    ...
    <div className="min-h-screen bg-[#E6F3F7] flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md space-y-8 animate-in fade-in zoom-in duration-500">
        <div className="text-center space-y-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-[#2C5F6D] tracking-wider uppercase" style={{ fontFamily: "'Libre Baskerville', serif", letterSpacing: '0.15em' }}>Olde Mill Stream RV Resort</h1>
